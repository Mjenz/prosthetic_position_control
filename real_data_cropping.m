% use MATLAB to crop the csv files to the desired arm swing
...
output_filename = 'src/data_profile_REAL_cropped.c';
...
lower = [1352,1180,585,822];
upper = [1466,1293,686,921];
...
for i = 1:length(csv_filename)
    ...
    fprintf(fid, 'float Angle_Profile_REAL_cropped_%d[%d] = \n{\n', 7 + (i-1)*2, upper(file_number)-lower(file_number));

...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ADC_MCUX_12B1MSPS_SAR, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NXP_KINETIS_FLEXCAN_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_PART_NUMBER_MIMXRT1062DVJ6A, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_INA219, 1);
